...
scene.onOverlapTile(SpriteKind.Player, assets.tile`Marco0`, function (sprite, location) {
    game.showLongText("Linguini: Where-eh am I?", DialogLayout.Top)
    game.showLongText("Claire: Oh my god!", DialogLayout.Top)
    game.showLongText("Claire: Is that Linguini from the 1985 classic", DialogLayout.Top)
    game.showLongText("Claire: Ordinary Marco cousins!?", DialogLayout.Top)
    game.showLongText("Marco: It's-eh I! Linguini!", DialogLayout.Top)
    game.showLongText("Claire: What are you doing in the walls?", DialogLayout.Top)
    game.showLongText("Linguini: Your-eh guess is as good as mine-eh", DialogLayout.Top)
    game.showLongText("Claire: Where's Marco?", DialogLayout.Top)
    game.showLongText("Linguini: oh yeah! Be-eh carefull when talking to him.", DialogLayout.Top)
    game.showLongText("Linguini: He's been-eh bit angry.", DialogLayout.Top)
    game.showLongText("Linguini: That's why I'm-eh over here.", DialogLayout.Top)
    game.showLongText("Linguini: He yelled at me.", DialogLayout.Top)
})
